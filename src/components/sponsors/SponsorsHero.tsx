...
export default function SponsorsHero() {
  return (
    <section className="relative flex min-h-[58vh] items-center justify-center overflow-hidden pt-20">
      ...
      >
        ...
        <h1 className="mt-6 text-balance font-display text-[2.5rem] font-medium leading-[1.07] text-cream sm:text-6xl">
          The generosity behind the night
        </h1>
        <p className="mt-6 max-w-xl text-pretty font-sans text-base leading-relaxed text-cream/90 sm:text-lg">
          Our sponsors and donors are the reason the Westside Burns Night Association has
          given more than $200,000 to charity. Thank you.
        </p>
      </motion.div>
    </section>
  );
